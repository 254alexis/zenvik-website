...
function TechnologyBackgroundIcon({ type }) {
  if (type === "laravel") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <path d="M18 31 52 14l34 17v38L52 87 18 69V31Z" /><path d="M52 14v73M18 31l34 18 34-18M18 69l34-20 34 20" /><path d="m52 49 24 13-24 13-24-13 24-13Z" />
    </svg>
  )
  if (type === "wordpress") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <circle cx="60" cy="60" r="44" /><path d="M29 42c9-7 19-10 31-10 12 0 23 4 31 11M34 38l21 52 13-34 13 34 16-44M48 46h38M63 46c8 10 11 22 7 34" />
    </svg>
  )
  if (type === "react") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <ellipse cx="60" cy="60" rx="45" ry="17" /><ellipse cx="60" cy="60" rx="45" ry="17" transform="rotate(60 60 60)" /><ellipse cx="60" cy="60" rx="45" ry="17" transform="rotate(120 60 60)" /><circle cx="60" cy="60" r="7" fill="currentColor" stroke="none" />
    </svg>
  )
  if (type === "mysql") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <ellipse cx="60" cy="28" rx="38" ry="16" /><path d="M22 28v54c0 9 17 16 38 16s38-7 38-16V28M22 55c0 9 17 16 38 16s38-7 38-16" /><path d="M36 48c14 7 34 7 48 0" />
    </svg>
  )
  if (type === "cloud") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <path d="M34 82h51a20 20 0 0 0 3-39 30 30 0 0 0-56-7A24 24 0 0 0 34 82Z" /><path d="M38 95h44M49 104h22" />
    </svg>
  )
  if (type === "ai") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <rect x="29" y="29" width="62" height="62" rx="18" /><path d="M41 52h-20M41 68h-20M79 52h20M79 68h20M52 41v-20M68 41v-20M52 79v20M68 79v20" /><path d="M48 61c6-15 20-15 25 0 6 17-23 16-13 31M48 72c9 5 17-6 26 0" />
    </svg>
  )
  if (type === "cyber") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <path d="M60 14 96 28v30c0 25-14 42-36 53-22-11-36-28-36-53V28l36-14Z" /><path d="m43 62 12 12 25-31" /><path d="M37 93c15 7 31 7 46 0" />
    </svg>
  )
  if (type === "hosting") return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <rect x="27" y="18" width="66" height="84" rx="10" /><path d="M41 37h38M41 58h38M41 79h38" /><circle cx="41" cy="37" r="3" fill="currentColor" stroke="none" /><circle cx="41" cy="58" r="3" fill="currentColor" stroke="none" /><circle cx="41" cy="79" r="3" fill="currentColor" stroke="none" />
    </svg>
  )
  return (
    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" viewBox="0 0 120 120">
      <rect x="21" y="25" width="78" height="70" rx="12" /><path d="M21 47h78M45 66l-13 11 13 11M75 66l13 11-13 11M64 62l-8 30" />
    </svg>
  )
}
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      {technologyBackgroundItems.map((item) => (
        <div key={item.type} className="absolute" style={{ color: item.color, height: item.size, left: item.left, opacity: 0.04, top: item.top, transform: `rotate(${item.rotate})`, width: item.size }}>
          <TechnologyBackgroundIcon type={item.type} />
        </div>
      ))}
      <svg className="absolute inset-0 h-full w-full" fill="none" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 1440 980">
        <path d="M110 190h160c84 0 96 86 176 86h232M908 210h170c70 0 92 72 166 72h112M148 742h198c88 0 98-94 186-94h180M820 712h210c80 0 98-82 190-82h116" stroke="#043a7e" strokeOpacity="0.04" strokeWidth="2" />
        <path d="M1190 90 1324 142v94c0 70-50 122-134 154-84-32-134-84-134-154v-94l134-52Z" stroke="#dfa408" strokeOpacity="0.045" strokeWidth="2" />
        <path d="M190 500h120a46 46 0 0 0 8-91 72 72 0 0 0-136-14 52 52 0 0 0 8 105Z" stroke="#043a7e" strokeOpacity="0.04" strokeWidth="2" />
        <path d="M600 136c42-34 78 34 120 0s78 34 120 0M600 184c42-34 78 34 120 0s78 34 120 0" stroke="#7a6200" strokeOpacity="0.04" strokeWidth="2" />
        <path d="M1030 520c0 25-58 45-130 45s-130-20-130-45 58-45 130-45 130 20 130 45ZM770 520v96c0 25 58 45 130 45s130-20 130-45v-96" stroke="#043a7e" strokeOpacity="0.04" strokeWidth="2" />
        <path d="M438 820 512 776l74 44v78l-74 44-74-44v-78Z" stroke="#dfa408" strokeOpacity="0.045" strokeWidth="2" />
      </svg>
    </div>
  )
}
...
function DiagramNode({ x, y, width = 34, height = 20, rx = 7, fill = "rgba(4,58,126,0.07)" }) {
  return <rect x={x} y={y} width={width} height={height} rx={rx} fill={fill} stroke="rgba(4,58,126,0.2)" strokeWidth="1.4" />
}

function GoldLine({ d, opacity = 0.72 }) {
  return <path d={d} stroke="#dfa408" strokeLinecap="round" strokeLinejoin="round" strokeOpacity={opacity} strokeWidth="1.6" />
}
...
function ServiceVisual({ type, index }) {
  ...
  if (type === "cloud") return (
    <ServiceStage>
      <GoldLine d="M101 47 L63 88" /><GoldLine d="M110 48 L110 88" /><GoldLine d="M119 47 L157 88" />
  ...
  if (type === "website") return (
    <ServiceStage>
      <GoldLine d="M98 84 L64 103" opacity={0.64} /><GoldLine d="M110 84 L110 100" opacity={0.64} /><GoldLine d="M122 84 L156 98" opacity={0.64} />
...
function ServicesSection() {
  ...
  useEffect(() => {
    ...
    async function runSpotlight() {
      for (let i = 0; i < coreServices.length; i++) {
        ...
        if (cancelled) return
        setActiveCard(-1)
        if (i < coreServices.length - 1) await sleep(GAP_MS)
      }
      if (cancelled) return
      await sleep(GAP_MS)
      setAllConnected(true)
      await sleep(FINAL_MS)
      if (!cancelled) setAllConnected(false)
    }
  ...
  return (
    <section ref={sectionRef} id="services" className="relative overflow-hidden bg-light py-16 lg:py-20">
      ...
      <motion.span className="absolute left-[12%] top-24 h-2 w-2 rounded-full bg-accent" animate={{ opacity: [0.03, 0.05, 0.03] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} />
      <motion.span className="absolute right-[16%] top-44 h-2 w-2 rounded-full bg-primary" animate={{ opacity: [0.03, 0.05, 0.03] }} transition={{ duration: 4.8, repeat: Infinity, ease: "easeInOut", delay: 0.8 }} />
            ...
            return (
              ...
              >
                <motion.article
                  ...
                  className="group flex h-full flex-col overflow-hidden rounded-3xl border bg-white shadow-soft backdrop-blur"
                  style={{
                    borderColor,
                    boxShadow,
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col bg-primary p-6 text-white">
                    ...
                    <p className="mt-3 flex-1 leading-relaxed text-white/78">{service.description}</p>
                    <a
                      href={service.href}
